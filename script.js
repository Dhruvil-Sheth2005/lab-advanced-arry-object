...
const squaredNumbers = numbers.map((num) => Math.pow(parseInt(num), 2));
...
const concatenatedAlphabets = alphabets.reduce(
...
const indexOf7 = ranks.findIndex((rank) => rank === 7);
...
// 1. Delete the "phoneno" property
delete person.phoneno;

// 2. Check for properties using hasOwnProperty
console.log(person.vehicles.hasOwnProperty('bike')); // true
console.log(person.hasOwnProperty('house')); // false

// 3. Access information
console.log(`Mr ${person.name} travels by plane called Air123`);

// 4. Change the email property
person.email = 'ajaykumar@gmail.com';
console.log(person);

// 5. Generate an array of keys
